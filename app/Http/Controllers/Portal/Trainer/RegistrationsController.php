...
class RegistrationsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('portal.trainers.registrations.create', compact('countries'));
    }
    ...
    public function show($id)
    {
        ...
        return view('portal.trainers.registrations.show', compact('registration'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('portal.trainers.registrations.edit', compact('registration', 'countries'));
    }
