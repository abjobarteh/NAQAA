...
class TrainerRegistrationApplication extends Component
{
    ...
    {
        return view('livewire.registration-accreditation.manage-applications.trainer-registration-application');
    }
}
