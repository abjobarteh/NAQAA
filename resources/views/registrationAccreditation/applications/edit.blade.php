                                ...
                                <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="classification_id" id="classification_id" class="form-control select2" required>
                                                        ...
                                                        @foreach ($categories as $id => $categories)
                                                            <option value="{{$id}}" {{ $registration->trainingprovider->classification_id == $id ? 'selected' :'' }}>{{$categories}}</option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        {{-- <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="checklists">Attached Documents</label>
                                                    {{$registration->application_checklists}}
                                                </div>
                                            </div>
                                        </div> --}}
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <a href="{{route('registration-accreditation.applications.index')}}" class="btn btn-warning"><i class="fas fa-arrow-left"></i> Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
