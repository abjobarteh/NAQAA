<div>
    <div class="modal fade" id="trainer-assessment-modal" wire:ignore.self>
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title"><strong>{{$student_detail->student->full_name ?? 'Student'}}</strong> Assesment Details</h4>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <label for="assessment_center">Verifier Comments</label>
                            <textarea id="verifier_comments" cols="30" rows="10" wire:model="verifier_comments"></textarea>
                        </div>
                    </div>
                </div>
                @endif
