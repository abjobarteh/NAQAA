<div>
    @section('title','Edit Letter of Interim Authorisation Application')
        ...
        <div class="fade-in">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-6">
                            <h4 class="card-title">Edit Application for Letter of Interim Authorisation</h4>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 d-flex justify-content-center">
                            <button type="submit" id="submit" class="btn btn-success btn-square btn-block">Update</button>
                        </div>
                    </div>
                </form>
            </div>
