                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6 d-flex flex-direction-row justify-content-end">
                                    <a href="{{route('portal.institutions.student-registrations')}}" class="btn btn-success btn-flat mr-1"><i class="fas fa-list"></i> Registered Students</a>
                                    <a href="{{route('portal.institution.edit-student-registration',$student_registration->id)}}" class="btn btn-danger btn-flat"><i class="fas fa-edit"></i> Edit Student Registration</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
