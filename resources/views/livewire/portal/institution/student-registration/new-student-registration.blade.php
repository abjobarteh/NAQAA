<div>
@section('page-title','New GSQ Student Registration')
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6 d-flex flex-direction-row justify-content-end">
                                <a href="{{route('portal.institution.student-registrations')}}" class="btn btn-success"><i class="fas fa-list"></i> Registered Students</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
