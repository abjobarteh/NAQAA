<div>
    <div>
        @section('page-title','Edit Student Registration')
    
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12 col-md-6">
                    <h1 class="m-0">Edit Student Registration</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-12 col-md-6">
                        <img src="{{$student_registration->registeredStudent->picture ?? '/storage/uploads/no-image.png'}}" class="rounded-circle float-right" alt="Student Image" width="50">
                    </div>
                </div><!-- /.row -->
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="card-title"><i class="fas fa-edit text-danger"></i> Edit Student Registration</h3>
                                </div>
                                <div class="col-md-6 d-flex flex-direction-row justify-content-end">
                                    <a href="{{route('portal.institution.student-registrations')}}" class="btn btn-success btn-flat"><i class="fas fa-list"></i> Registered Students</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            @if ($is_error || $is_success)
                                <div class="alert @if($is_error) alert-danger @else alert-success @endif alert-dismissible fade show" role="alert">
                                    {{$message}}
                            ...
                            @endif
                            <form wire:submit.prevent="updateStudentRegistration" enctype="multipart/form-data" autocomplete="off">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-12">
