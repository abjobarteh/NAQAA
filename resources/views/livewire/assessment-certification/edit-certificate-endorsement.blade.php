<div>
    <div>
        @section('page-title','Edit Certificate Endorsements')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3 class="card-title"><i class="fas fa-edit text-danger"></i> Edit Certificate Endorsement</h3>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form wire:submit.prevent="updateEndorsement" autocomplete="off">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-12">
