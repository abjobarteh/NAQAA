<div>
    <div>
        @section('page-title','View Student Registration')
    
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12 col-md-6">
                    <h1 class="m-0">View Student Registration</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-12 col-md-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="card-title"><i class="fas fa-eye text-info"></i> View Student Registration</h3>
                                </div>
                                <div class="col-md-6 d-flex flex-direction-row justify-content-end">
                                    <a href="{{route('assessment-certification.registrations.index')}}" class="btn btn-success btn-flat mr-1"><i class="fas fa-list"></i> Registered Students</a>
                                    <a href="{{route('assessment-certification.edit-student-registration',$student_registration->id)}}" class="btn btn-danger btn-flat"><i class="fas fa-edit"></i> Edit Student Registration</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
