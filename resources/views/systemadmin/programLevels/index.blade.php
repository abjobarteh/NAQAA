        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <div class="float-right">
                    ...
                    <a href="{{ route('admin.program-levels.create') }}" class="btn btn-info">Add</a>
                    @endcan
                </div>
            </div><!-- /.col -->
        </div><!-- /.row -->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.program-levels.edit', $programlevel->id) }}" class="btn btn-danger btn-sm"><i class="fas fa-edit "></i> Edit</a>
                                        @endcan
