                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="card-title text-primary"><i class="fas fa-edit text-danger"></i> Edit Student Details</h3>
                                </div>
                                <div class="col-md-6 d-flex flex-direction-row justify-content-end">
                                    ...
                                    <a href="{{route('assessment-certification.registrations.create')}}" class="btn btn-primary btn-flat"><i class="fas fa-plus"></i> New Student Registration</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
