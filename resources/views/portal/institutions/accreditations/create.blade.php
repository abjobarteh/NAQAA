                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="programme_title" name="programme_title" class="form-control" value="{{old('programme_title')}}" required>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="mentoring_institution" name="mentoring_institution" class="form-control" value="{{old('mentoring_institution')}}" required>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="mentoring_institution_address" name="mentoring_institution_address" class="form-control" value="{{old('mentoring_institution_address')}}">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="file" id="programme_affiliation_proof" name="programme_affiliation_proof" class="form-control" value="{{old('programme_affiliation_proof')}}">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <textarea class="form-control" id="programme_aims" name="programme_aims" rows="4" placeholder="Programme Aims..">{{old('programme_aims')}}</textarea>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <textarea class="form-control" id="programme_objectives" name="programme_objectives" rows="4" placeholder="Programme objectives..">{{old('programme_objectives')}}</textarea>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="admission_requirements" name="admission_requirements" class="form-control" value="{{old('admission_requirements')}}" required>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="progrssion_requirements" name="progrssion_requirements" class="form-control" value="{{old('progrssion_requirements')}}">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <textarea class="form-control" id="learning_outcomes" name="learning_outcomes" rows="4" placeholder="Briefly explain the student learning outcomes..">{{old('learning_outcomes')}}</textarea>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="studentship_duration" name="studentship_duration" class="form-control" value="{{old('studentship_duration')}}" required>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="total_qualification_time" name="total_qualification_time" class="form-control" value="{{old('total_qualification_time')}}">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="number" id="level_of_fees" name="level_of_fees" class="form-control" value="{{old('level_of_fees')}}" min="0" step="1" required>
                            @error('level_of_fees')
                                <span class="text-danger mt-1">{{$message}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="department_name" name="department_name" class="form-control" value="{{old('department_name')}}" required>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input class="form-control" id="date-input" type="date" name="department_establishment_date" value="{{old('department_establishment_date')}}"><span class="help-block">Please enter a valid date</span>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="file" id="programme_structure" name="programme_structure" class="form-control" value="{{old('programme_structure')}}">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <textarea class="form-control" id="external_examiners_appointment_evidence" name="external_examiners_appointment_evidence" rows="5" 
                             placeholder="Briefly describe the appointment process of external examiners..">
                                {{old('external_examiners_appointment_evidence')}}
                            </textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            placeholder="Briefly describe the mode of certification and the requirements for graduation in the programme. Also explain how
                            repeats in final examination are handled..">
                                {{old('provided_safety_facilities')}}
                            </textarea>
...
@section('scripts')
    <script>
            ...
            $("#add_department_head").click(function(e){
                e.preventDefault();
                let new_row_number = departmenthead_row_number - 1;
                $('#departmentheads' + departmenthead_row_number).html($('#departmentheads' + new_row_number).html()).find('td:first-child');
                $('#department_heads_table').append('<tr id="departmentheads' + (departmenthead_row_number + 1) + '"></tr>');
                departmenthead_row_number++;
            });

            $("#delete_department_head").click(function(e){
                e.preventDefault();
                if(departmenthead_row_number > 1){
                    $("#departmentheads" + (departmenthead_row_number - 1)).html('');
                    departmenthead_row_number--;
                }
            });
    </script>
