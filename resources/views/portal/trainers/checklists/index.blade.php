           ...
           <div class="card-header">
               <div class="row">
                   ...
                   <div class="col-sm-6 d-flex justify-content-end">
                        <a href="{{route('portal.trainer.checklist-evidence.create')}}" class="btn btn-success btn-square">
                ...
                <tbody>
                  @forelse ($checklist_evidences as $evidence)
                    <tr>
                      ...
                      <td>
                        <a href="{{route('portal.trainer.checklist-evidence.edit',$evidence->id)}}" class="btn btn-sm btn-danger"
