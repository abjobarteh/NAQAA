                                ...
                                <tr>
                                  ...
                                  <td>
                                    @if($application->status == 'Pending')
                                      <a href="{{route('portal.trainer.registrations.edit',$application->id)}}" class="btn btn-sm btn-danger"
                                        title="Edit Trainer application">
                                        <i class="fas fa-edit"></i>
                                      </a>
                                    @endif
                                    <a href="{{route('portal.trainer.registrations.show',$application->id)}}" class="btn btn-sm btn-info"
                                      title="View Trainer application">
