    ...
    <div class="content-heaer">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <h1 class="m-0">Edit Research Survey</h1>
                </div><!-- /.col -->
                <div class="col-sm-6 col-md-6">
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item active">Edit research survey</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div>
                        ...
                        <div class="card-body">
                            <form action="{{route('researchdevelopment.research-survey-documentation.update', $survey[0]->id)}}" method="POST" autocomplete="off">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="research_topic" value="{{$survey[0]->research_topic}}" required autofocus>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="publisher" value="{{$survey[0]->publisher}}" required autofocus>
                                                    @error('publisher')
                                                        <span class="text-danger mt-1">{{$message}}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="publication_date" data-target-input="nearest">
                                                        <input type="text" class="form-control datetimepicker-input" name="publication_date" value="{{$survey[0]->publication_date}}" data-target="#completion_date"/>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="funded_by" value="{{$survey[0]->funded_by}}" required autofocus>
                                                    @error('funded_by')
                                                        <span class="text-danger mt-1">{{$message}}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="cost" value="{{$survey[0]->cost}}" required autofocus>
                                                    @error('cost')
                                                        <span class="text-danger mt-1">{{$message}}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Purpose: <sup class="text-danger">*</sup></label>
                                                      <textarea class="form-control" name="purpose">{{$survey[0]->purpose}}</textarea>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Key Findings: <sup class="text-danger">*</sup></label>
                                                      <textarea class="form-control" name="key_findings">{{$survey[0]->key_findings}}</textarea>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Recommendation: <sup class="text-danger">*</sup></label>
                                                      <textarea class="form-control" name="recommendation">{{$survey[0]->recommendation}}</textarea>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Remarks: <sup class="text-danger">*</sup></label>
                                                      <textarea class="form-control" name="remarks">{{$survey[0]->remarks}}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <a href="{{route('researchdevelopment.research-survey-documentation.index')}}" class="btn btn-block btn-warning text-white"><i class="fas fa-arrow-left"></i> Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
